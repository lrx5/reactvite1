...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    { id: 9, file: 'friends-list-website', title: 'Friends List Website', description: 'Vanilla HTML', img: 'friendslistv_t.png' },
    { id: 8, file: 'create-with-clint-double-memory', title: 'Memory', description: 'Blender', img: 'memory_t.png' },
    ...
    { id: 4, file: 'mystery-word', title: 'Mystery Word: Five Words', description: 'Unity', img: 'mw_t.jpg' },
